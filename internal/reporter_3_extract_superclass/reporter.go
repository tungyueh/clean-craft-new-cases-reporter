...
type NewCasesCalculator struct {
	totalCases  int
...
func (r *NewCasesCalculator) calculateCounties(lines []string) {
...
func (r *NewCasesCalculator) calcluateCounty(line string) County {
...
func (r *NewCasesCalculator) incrementStateCount(state string, cases int) {
	r.stateCounts[state] = r.stateCounts[state] + cases
}

func (*NewCasesCalculator) calculateSumOfCases(tokens []string) int {
	cases := 0
...
func (*NewCasesCalculator) calculateRollingAverage(tokens []string) float64 {
